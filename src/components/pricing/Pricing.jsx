...
import "./Pricing.css";
import Image1 from "../assets/assets/price-1.svg";
import Image2 from "../assets/assets/price-2.svg";
import Image3 from "../assets/assets/price-3.svg";
    ...
    <section className="pricing container section" id="pricing">
      ...
      <div className="pricing__container grid">
        ...
        <div className="pricing__item best">
          <span className="padge">Recommended</span>
